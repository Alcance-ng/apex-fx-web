...
export default function SuperAdminTransactionsPage() {
  ...
  const { transactions, isLoading, error } = useSuperAdminTransactions(token);
  ...
  function getTxIcon(
    tx: import("@/hooks/useSuperAdminTransactions").Transaction
  ) {
    if (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#170a0e] via-[#2a0f1a] to-[#3b0f24] text-white">
      <header className="bg-[#2a0f1a]/80 backdrop-blur-md shadow-sm border-b border-red-900">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-red-200">All Transactions</h1>
          <button
            onClick={() => router.back()}
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-[#2a0f1a]/80 backdrop-blur-md rounded-xl shadow-2xl p-8 border border-red-900">
          <h2 className="text-lg font-bold text-red-200 mb-6">
            Transaction List
          </h2>
          <div className="mb-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
            <input
              ...
              className="px-3 py-2 rounded bg-[#170a0e] text-white border border-red-900 focus-visible:ring-2 focus-visible:ring-purple-400"
            />
            <select
              value={statusFilter || ""}
              onChange={(e) => {
