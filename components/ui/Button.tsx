...
export function Button({
  ...
  const variantClasses = {
    primary: "bg-gradient-to-r from-green-500 via-emerald-500 to-lime-500 text-white shadow-lg hover:from-green-600 hover:via-emerald-600 hover:to-lime-600 focus:ring-yellow-400",
